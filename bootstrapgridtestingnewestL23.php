            ...
            $.ajax({ //create an ajax request to display.php
                ...
                success: function(response) {
                    ...
                    var L23assembly1 =
                        ...
                        $sql = "select * from production_line_L23 where station_group = 'assembly' and operating ='1' ORDER BY order_no ASC";
                    ...
                    var L23inspection1 =
                        ...
                        $sql = "select * from production_line_L23 where station_group = 'inspection' and operating ='1' ORDER BY order_no ASC";
                        if ($result = mysqli_query($conn, $sql)) {
                            $rowcount = mysqli_num_rows($result);
                            echo $rowcount;
                        }
                    ...
                    var L23packing1 =
                        ...
                        $sql = "select * from production_line_L23 where station_group = 'packing' and operating ='1' ORDER BY order_no ASC";
                        if ($result = mysqli_query($conn, $sql)) {
                            $rowcount = mysqli_num_rows($result);
                            echo $rowcount;
                        }
                    ...
                    <?php
                    $sql = mysqli_query($conn, "SELECT * FROM production_line_L23 where station_group = 'assembly' and operating ='1' ORDER BY order_no ASC");
                    ...
                    <?php
                    $sql = mysqli_query($conn, "SELECT * FROM production_line_L23 where station_group = 'inspection' and operating ='1' ORDER BY order_no ASC");
                    ...
                    <?php
                    $sql = mysqli_query($conn, "SELECT * FROM production_line_L23 where station_group = 'packing' and operating ='1' ORDER BY order_no ASC");
