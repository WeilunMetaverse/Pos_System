            ...
            $.ajax({ //create an ajax request to display.php
                ...
                success: function(response) {
                    ...
                    var L23assembly1 =
                        ...
                        $sql = "select * from production_line_L23 where station_group = 'assembly'";
                    ...
                    var L23inspection1 =
                        ...
                        $sql = "select * from production_line_L23 where station_group = 'inspection'";
                        if ($result = mysqli_query($conn, $sql)) {
                            $rowcount = mysqli_num_rows($result);
                            echo $rowcount;
                        }
                    ...
                    var L23packing1 =
                        ...
                        $sql = "select * from production_line_L23 where station_group = 'packing'";
                        if ($result = mysqli_query($conn, $sql)) {
                            $rowcount = mysqli_num_rows($result);
                            echo $rowcount;
                        }
                    ...
                    for (i = 0; i <= L23assembly1; i++) {
                        if (i == 0 || i == L23assemblyroller) { //L23assemblyroller last box if we need another second box we just put i==L23assemblyback
                            $("#L23flexdisplay1").append(
                                ...
                                '<div id="L23backstatus' + (i - 1) + '" class="card__front" style="color: black;background-color: transparent;">' +
                                '</div>' +
                                '</div>'
                            );
                        } else {
                            ...
                            $("#L23flexdisplay1").append(
                                ...
                                '<div id="L23backstatus' + (i - 1) + '" class="card__front" style="color: black;background-color: green;">' +
                                '<a style="top:60%;text-align: left;place-content: CUC9;">' +
                                '<div id="svgL23backstatus' + (i - 1) + '" class="btnforsvg" style="background-color: green;">' +
                                '<img class="L23imgassem' + (i - 1) + '" src="media/robotarm.gif" alt="" style="">' +
                                '</div>' +
                    ...
                    for (i = 0; i <= L23inspection1; i++) {
                        if (i == 0 || i == L23inspectionroller) {
                            ...
                            $("#L23flexdisplay2").append(
                                ...
                                '<div id="L23backstatusinspec' + (i - 1) + '" class="card__front" style="color: black;background-color: green;">' +
                                '<a style="top:60%;text-align: left;place-content: CUC9;">' +
                                '<div id="svgL23backstatusinspec' + (i - 1) + '" class="btnforsvg" style="background-color: green;">' +
                                '<img class="L23imginspec' + (i - 1) + '" src="media/robotarm.gif" alt="" style="">' +
                                '</div>' +
                                '<div class="wrapperstation23" style="background-color: transparent;" >' +
                                '<a class="reviews">' + (i) +
                                '<div class="popupstation23">' +
                    ...
                    for (i = 0; i <= L23packing1; i++) {
                        if (i == 0 || i == L23packingroller || i == L23packingback) {
                            ...
                            $("#L23flexdisplay3").append(
                                ...
                                '<a style="top:60%;text-align: left;place-content: CUC9;">' +
                                '<div id="svgL23backstatuspack' + (i - 1) + '" class="btnforsvg" style="">' +
                                '<img class="L23imgpack' + (i - 1) + '" src="media/robotarm.gif" alt="" style="">' +
                                '</div>' +
                                '<div class="wrapperstation23" style="background-color: transparent;" >' +
                                '<a class="reviews">' + (i) +
                                ...
                                '<div class="card__back"  style="background-color: white;">' +
                                '<div style="text-align:center;">' +
                                '<p><img class="L23computerdisplaypack' + (i - 1) + '"  style="width:60%;height:40%;"></p>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                    ...
                    <?php
                    $sql = mysqli_query($conn, "SELECT * FROM production_line_L23 where station_group = 'assembly'");
                    ...
                    for (i = 0; i <= (L23assembly1 - 2); i++) {
                        ...
                        if (array1[i] == 1) {
                            ...
                            $(".L23imgassem" + i).attr("src", "media/operator.gif");
                        }
                    ...
                    for (i = 0; i <= (L23assembly1 - 2); i++) {
                        ...
                        if (array3[i] == "stop") {
                            ...
                            $("#svgL23backstatus" + i).css("animation", "red 1s infinite");


                        } else if (array3[i] == "breaks") {
                            $("#L23backstatus" + i).css("animation", "yellow 1s infinite");
                            $("#svgL23backstatus" + i).css("animation", "yellow 1s infinite");

                        } else if (array3[i] == "offline") {
                            $("#L23backstatus" + i).css("animation", "grey 1s infinite");
                            $("#svgL23backstatus" + i).css("animation", "grey 1s infinite");

                        } else {
                            $("#L23backstatus" + i).css("animation", "green 1s infinite");
                            $("#svgL23backstatus" + i).css("animation", "green 1s infinite");
                        }
                    ...
                    <?php
                    $sql = mysqli_query($conn, "SELECT * FROM production_line_L23 where station_group = 'inspection'");
                    ...
                    for (i = 0; i <= (L23inspection1 - 2); i++) {
                        ...
                        if (arrayinspec1[i] == 1) {
                            ...
                            $(".L23imginspec" + i).attr("src", "media/operator.gif");
                        }
                    ...
                    for (i = 0; i <= (L23inspection1 - 2); i++) {
                        ...
                        if (arrayinspec3[i] == "stop") {
                            ...
                            $("#svgL23backstatusinspec" + i).css("animation", "red 1s infinite");


                        } else if (arrayinspec3[i] == "breaks") {
                            $("#L23backstatusinspec" + i).css("animation", "yellow 1s infinite");
                            $("#svgL23backstatusinspec" + i).css("animation", "yellow 1s infinite");

                        } else if (arrayinspec3[i] == "offline") {
                            $("#L23backstatusinspec" + i).css("animation", "grey 1s infinite");
                            $("#svgL23backstatusinspec" + i).css("animation", "grey 1s infinite");

                        } else {
                            $("#L23backstatusinspec" + i).css("animation", "green 1s infinite");
                            $("#svgL23backstatusinspec" + i).css("animation", "green 1s infinite");
                        }
                    ...
                    <?php
                    $sql = mysqli_query($conn, "SELECT * FROM production_line_L23 where station_group = 'packing'");
                    ...
                    for (i = 0; i <= (L23packing1 - 3); i++) {
                        ...
                        if (arraypack1[i] == 1) {
                            ...
                            $(".L23imgpack" + i).attr("src", "media/operator.gif");
                        }
                    ...
                    for (i = 0; i <= (L23packing1 - 3); i++) {
                        ...
                        if (arraypack3[i] == "stop") {
                            ...
                            $("#svgL23backstatuspack" + i).css("animation", "red 1s infinite");


                        } else if (arraypack3[i] == "breaks") {
                            $("#L23backstatuspack" + i).css("animation", "yellow 1s infinite");
                            $("#svgL23backstatuspack" + i).css("animation", "yellow 1s infinite");

                        } else if (arraypack3[i] == "offline") {
                            $("#L23backstatuspack" + i).css("animation", "grey 1s infinite");
                            $("#svgL23backstatuspack" + i).css("animation", "grey 1s infinite");

                        } else {
                            $("#L23backstatuspack" + i).css("animation", "green 1s infinite");
                            $("#svgL23backstatuspack" + i).css("animation", "green 1s infinite");
                        }
