        ...
        <div class="side corner">
          ...
          <div class="side top">
            <div class="chakalaka">
              ...
              <div id="L08part6a" class="chakalaka-top" style="background:black;">
                  ...
                  <div class="cylinder">
                    <div class="cylinder-side color2">
                      <div class="cylinder-side">
                        <div class="cylinder-side color2">
                          <div class="cylinder-side">
                            <div id="L08part6b" class="cylinder-side color2" style="background:black;">
                              <div id="L08part6c" class="cylinder-side" style="background:black;">
                                <div id="L08part6d" class="cylinder-side color2" style="background:black;">
                                  <div id="L08part6e" class="cylinder-side"style="background:black;">
