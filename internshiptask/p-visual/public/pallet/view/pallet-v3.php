        ...
        function getLineStatus() {
            $.ajax({ //create an ajax request to display.php
                ...
                success: function(response) {
                    ...
                    if (lineStatus == "breaktime") {
                        if (reload == false) {
                            location.reload(true);
                            reload = true;
                        } else
                            console.log("Its breaktime and data already reload once.")
                    } else {
                        reload = false;
                    }
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <div class="row" style="padding-left:30px">
                                <!-- Lifter 1 -->
                                <script>
                                    // Stopwatch for Lifter 1

                                    var secondsL1 = 00;
                                    var tensL1 = 00;
                                    var IntervalL1;

                                    function startTimerL1() {
                                        tensL1++;
                                        // console.log("tenns:"+tensL1);  
                                        if (tensL1 < 9) {
                                            // appendTensL1.innerHTML = "0" + tensL1;
                                            $("#tensL1").html("0" + tensL1);
                                        }
                                        if (tensL1 > 9) {
                                            // appendTensL1.innerHTML = tensL1;
                                            $("#tensL1").html(tensL1);
                                        }
                                        if (tensL1 > 99) {
                                            // console.log("seconds");
                                            secondsL1++;
                                            // appendSecondsL1.innerHTML = "0" + secondsL1;
                                            $("#secondsL1").html("0" + secondsL1);
                                            tensL1 = 0;
                                            // appendTensL1.innerHTML = "0" + 0;
                                            $("#secondsL1").html("0" + secondsL1);
                                        }
                                        if (secondsL1 > 9) {
                                            // appendSecondsL1.innerHTML = secondsL1;
                                            $("#secondsL1").html(secondsL1);
                                        }
                                    }
                                </script>
                                ...
                                <script>
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        // IntervalL1 = setInterval(startTimerL1, 10);          
                                        getNewLifter1();
                                            ...
                                            $.ajax({ //create an ajax request to display.php
                                                ...
                                                success: function(response) {
                                                    ...
                                                    if (lifter01 != lifter1.number) {
                                                        ...
                                                        durationL1 = secondsL1 + (tensL1 / 100);
                                                        ...
                                                        //console.log("Current line status:" +lineStatus);
                                                        try {
                                                            if (lineStatus != "end") {
                                                                IntervalL1 = setInterval(startTimerL1, 10);
                                                            }
                                                        ...
                                                        if (lifter1.number != 0) {
                                                            if (startTimeL1 != 0) {
                                                                var tactTimeL1 = (Date.parse(timeL1) - Date.parse(startTimeL1)) / 1000;
                                                                console.log("Lifter 1 tact time:" + tactTimeL1);
                                                                saveTactTime1("lifter", "1", "assembly", tactTimeL1, palletNoL1, autoserialL1);
                                                            }
                                ...
                                <style>
                                    ...
                                    .cubelifter1.show-front {
                                        transform: translateZ(-50px) rotateY(-180deg);
                                    }

                                    .cubelifter1.show-right {
                                        transform: translateZ(-50px) rotateY(-90deg);
                                    }

                                    .cubelifter1.show-back {
                                        transform: translateZ(-50px) rotateY(180deg);
                                    }

                                    .cubelifter1.show-left {
                                        transform: translateZ(-50px) rotateY(90deg);
                                    }

                                    .cubelifter1.show-top {
                                        transform: translateZ(-50px) rotateX(-90deg);
                                    }

                                    .cubelifter1.show-bottom {
                                        transform: translateZ(-50px) rotateX(90deg);
                                    }
                                    ...
                                    .cubelifter1__face--front {
                                        background: (0, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter1__face--right {
                                        background: (60, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter1__face--back {
                                        background: (120, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter1__face--left {
                                        background: (180, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter1__face--top {
                                        background: (240, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter1__face--bottom {
                                        background: (300, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }
                                ...
                                <?php for ($i = 1; $i <= 10; $i++) : ?>
                                    <script>
                                        // Stopwatch for Assembly Station

                                        var secondsSA<?php echo $i; ?> = 00;
                                        var tensSA<?php echo $i; ?> = 00;
                                        var IntervalSA<?php echo $i; ?>;

                                        function startTimerSA<?php echo $i; ?>() {
                                            tensSA<?php echo $i; ?>++;
                                            if (tensSA<?php echo $i; ?> < 9) {
                                                $("#tensSA<?php echo $i; ?>").html("0" + tensSA<?php echo $i; ?>);
                                            }
                                            if (tensSA<?php echo $i; ?> > 9) {
                                                $("#tensSA<?php echo $i; ?>").html(tensSA<?php echo $i; ?>);
                                            }
                                            if (tensSA<?php echo $i; ?> > 99) {
                                                secondsSA<?php echo $i; ?>++;
                                                $("#secondsSA<?php echo $i; ?>").html("0" + secondsSA<?php echo $i; ?>);
                                                tensSA<?php echo $i; ?> = 0;
                                                $("#secondsSA<?php echo $i; ?>").html("0" + secondsSA<?php echo $i; ?>);
                                            }
                                            if (secondsSA<?php echo $i ?> > 9) {
                                                $("#secondsSA<?php echo $i; ?>").html(secondsSA<?php echo $i; ?>);
                                            }
                                        }
                                    </script>
                                                ...
                                                $.ajax({ //create an ajax request to display.php
                                                    ...
                                                    success: function(response) {
                                                        ...
                                                        if (station<?php echo $i; ?> != station.number) {
                                                            ...
                                                            // Stopawatch start 
                                                            clearInterval(IntervalSA<?php echo $i ?>);
                                                            durationA<?php echo $i ?> = secondsSA<?php echo $i ?> + (tensSA<?php echo $i ?> / 100);
                                                            // console.log(duration); 
                                                            tensSA<?php echo $i ?> = "00";
                                                            secondsSA<?php echo $i ?> = "00";
                                                            $("#secondsSA<?php echo $i ?>").html(secondsSA<?php echo $i ?>);
                                                            $("#tensSA<?php echo $i ?>").html(tensSA<?php echo $i ?>);
                                                            //console.log("Current line status:" +lineStatus);
                                                            try {
                                                                if (lineStatus != "end") {
                                                                    IntervalSA<?php echo $i ?> = setInterval(startTimerSA<?php echo $i ?>, 10);
                                                                }
                                                            ...
                                                            if (station.number != 0) {
                                                                if (startTimeA<?php echo $i; ?> != 0) {
                                                                    var tactTimeA<?php echo $i; ?> = (Date.parse(timeA<?php echo $i; ?>) - Date.parse(startTimeA<?php echo $i; ?>)) / 1000;
                                                                    saveTactTime1("station", "<?php echo $i; ?>", "assembly", tactTimeA<?php echo $i; ?>, palletNoA<?php echo $i; ?>, autoserialA<?php echo $i; ?>);
                                                                }
                                    ...
                                    <style>
                                        ...
                                        .cubeassembly<?php echo $i; ?>.show-front {
                                            transform: translateZ(-50px) rotateY(-180deg);
                                        }

                                        .cubeassembly<?php echo $i; ?>.show-right {
                                            transform: translateZ(-50px) rotateY(-90deg);
                                        }

                                        .cubeassembly<?php echo $i; ?>.show-back {
                                            transform: translateZ(-50px) rotateY(180deg);
                                        }

                                        .cubeassembly<?php echo $i; ?>.show-left {
                                            transform: translateZ(-50px) rotateY(90deg);
                                        }

                                        .cubeassembly<?php echo $i; ?>.show-top {
                                            transform: translateZ(-50px) rotateX(-90deg);
                                        }

                                        .cubeassembly<?php echo $i; ?>.show-bottom {
                                            transform: translateZ(-50px) rotateX(90deg);
                                        }
                                        ...
                                        .cubeassembly<?php echo $i; ?>__face--front {
                                            background: (0, 100%, 50%, 1);
                                            background-color: #ffc107;
                                        }

                                        .cubeassembly<?php echo $i; ?>__face--right {
                                            background: (60, 100%, 50%, 1);
                                            background-color: #ffc107;
                                        }

                                        .cubeassembly<?php echo $i; ?>__face--back {
                                            background: (120, 100%, 50%, 1);
                                            background-color: #ffc107;
                                        }

                                        .cubeassembly<?php echo $i; ?>__face--left {
                                            background: (180, 100%, 50%, 1);
                                            background-color: #ffc107;
                                        }

                                        .cubeassembly<?php echo $i; ?>__face--top {
                                            background: (240, 100%, 50%, 1);
                                            background-color: #ffc107;
                                        }

                                        .cubeassembly<?php echo $i; ?>__face--bottom {
                                            background: (300, 100%, 50%, 1);
                                            background-color: #ffc107;
                                        }
                                ...
                                <!-- Lifter 2  -->
                                <script>
                                    // Stopwatch for Lifter 2

                                    var secondsL2 = 00;
                                    var tensL2 = 00;
                                    var IntervalL2;

                                    function startTimerL2() {
                                        tensL2++;
                                        if (tensL2 < 9) {
                                            $("#tensL2").html("0" + tensL2);
                                        }
                                        if (tensL2 > 9) {
                                            $("#tensL2").html(tensL2);
                                        }
                                        if (tensL2 > 99) {
                                            secondsL2++;
                                            $("#secondsL2").html("0" + secondsL2);
                                            tensL2 = 0;
                                            $("#secondsL2").html("0" + secondsL2);
                                        }
                                        if (secondsL2 > 9) {
                                            $("#secondsL2").html(secondsL2);
                                        }
                                    }
                                </script>
                                            ...
                                            $.ajax({ //create an ajax request to display.php
                                                ...
                                                success: function(response) {
                                                    ...
                                                    if (lifter02 != lifter2.number) {
                                                        ...
                                                        durationL2 = secondsL2 + (tensL2 / 100);
                                                        tensL2 = "00";
                                                        secondsL2 = "00";
                                                        $("#secondsL2").html(secondsL2);
                                                        $("#tensL2").html(tensL2);
                                                        ...
                                                        try {
                                                            if (lineStatus != "end") {
                                                                IntervalL2 = setInterval(startTimerL2, 10);
                                                            }
                                                            if (lineStatus == "breaktime") {
                                                                clearInterval(IntervalL2);
                                                            }
                                                        ...
                                                        if (lifter2.number != 0) {
                                                            if (startTimeL2 != 0) {
                                                                var tactTimeL2 = (Date.parse(timeL2) - Date.parse(startTimeL2)) / 1000;
                                                                console.log("Lifter 2 tact time:" + tactTimeL2);
                                                                saveTactTime1("lifter", "2", "assembly", tactTimeL2, palletNoL2, autoserialL2);
                                ...
                                <style>
                                    ...
                                    .cubelifter2.show-front {
                                        transform: translateZ(-50px) rotateY(-180deg);
                                    }

                                    .cubelifter2.show-right {
                                        transform: translateZ(-50px) rotateY(-90deg);
                                    }

                                    .cubelifter2.show-back {
                                        transform: translateZ(-50px) rotateY(180deg);
                                    }

                                    .cubelifter2.show-left {
                                        transform: translateZ(-50px) rotateY(90deg);
                                    }

                                    .cubelifter2.show-top {
                                        transform: translateZ(-50px) rotateX(-90deg);
                                    }

                                    .cubelifter2.show-bottom {
                                        transform: translateZ(-50px) rotateX(90deg);
                                    }
                                    ...
                                    .cubelifter2__face--front {
                                        background: (0, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter2__face--right {
                                        background: (60, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter2__face--back {
                                        background: (120, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter2__face--left {
                                        background: (180, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter2__face--top {
                                        background: (240, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }

                                    .cubelifter2__face--bottom {
                                        background: (300, 100%, 50%, 1);
                                        background-color: #007bff;
                                    }
                            ...
                            <div class="row" style="padding-left:30px">
                                <!-- Lifter 3  -->
                                <script>
                                    // Stopwatch for Lifter 3

                                    var secondsL3 = 00;
                                    var tensL3 = 00;
                                    var IntervalL3;

                                    function startTimerL3() {
                                        tensL3++;
                                        if (tensL3 < 9) {
                                            $("#tensL3").html("0" + tensL3);
                                        }
                                        if (tensL3 > 9) {
                                            $("#tensL3").html(tensL3);
                                        }
                                        if (tensL3 > 99) {
                                            secondsL3++;
                                            $("#secondsL3").html("0" + secondsL3);
                                            tensL3 = 0;
                                            $("#secondsL3").html("0" + secondsL3);
                                        }
                                        if (secondsL3 > 9) {
                                            $("#secondsL3").html(secondsL3);
                                        }
                                    }
                                </script>
                                            ...
                                            $.ajax({ //create an ajax request to display.php
                                                ...
                                                success: function(response) {
                                                    ...
                                                    if (lifter03 != lifter3.number) {
                                                        ...
                                                        durationL3 = secondsL3 + (tensL3 / 100);
                                                        tensL3 = "00";
                                                        secondsL3 = "00";
                                                        $("#secondsL3").html(secondsL3);
                                                        $("#tensL3").html(tensL3);
                                                        ...
                                                        try {
                                                            if (lineStatus != "end") {
                                                                console.log(lineStatus);
                                                                IntervalL3 = setInterval(startTimerL3, 10);
                                                            }
                                                            if (lineStatus == "breaktime") {
                                                                clearInterval(IntervalL3);
                                                            }
                                                        ...
                                                        if (lifter3.number != 0) {
                                                            if (startTimeL3 != 0) {
                                                                var tactTimeL3 = (Date.parse(timeL3) - Date.parse(startTimeL3)) / 1000;
                                                                console.log("Lifter 3 tact time:" + tactTimeL3);
                                                                saveTactTime1("lifter", "3", "inspection", tactTimeL3, palletNoL3, autoserialL3);
                                ...
                                <style>
                                    ...
                                    .cubelifter3.show-front {
                                        transform: translateZ(-50px) rotateY(-180deg);
                                    }

                                    .cubelifter3.show-right {
                                        transform: translateZ(-50px) rotateY(-90deg);
                                    }

                                    .cubelifter3.show-back {
                                        transform: translateZ(-50px) rotateY(180deg);
                                    }

                                    .cubelifter3.show-left {
                                        transform: translateZ(-50px) rotateY(90deg);
                                    }

                                    .cubelifter3.show-top {
                                        transform: translateZ(-50px) rotateX(-90deg);
                                    }

                                    .cubelifter3.show-bottom {
                                        transform: translateZ(-50px) rotateX(90deg);
                                    }
                                    ...
                                    .cubelifter3__face--front {
                                        background: (0, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter3__face--right {
                                        background: (60, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter3__face--back {
                                        background: (120, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter3__face--left {
                                        background: (180, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter3__face--top {
                                        background: (240, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter3__face--bottom {
                                        background: (300, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }
                                ...
                                <?php for ($i = 1; $i <= 18; $i++) : ?>
                                    ...
                                    <script>
                                        // Stopwatch for Lifter 4

                                        var secondsSI<?php echo $i; ?> = 00;
                                        var tensSI<?php echo $i; ?> = 00;
                                        var IntervalSI<?php echo $i; ?>;

                                        function startTimerSI<?php echo $i; ?>() {
                                            tensSI<?php echo $i; ?>++;
                                            if (tensSI<?php echo $i; ?> < 9) {
                                                $("#tensSI<?php echo $i; ?>").html("0" + tensSI<?php echo $i; ?>);
                                            }
                                            if (tensSI<?php echo $i; ?> > 9) {
                                                $("#tensSI<?php echo $i; ?>").html(tensSI<?php echo $i; ?>);
                                            }
                                            if (tensSI<?php echo $i; ?> > 99) {
                                                secondsSI<?php echo $i; ?>++;
                                                $("#secondsSI<?php echo $i; ?>").html("0" + secondsSI<?php echo $i; ?>);
                                                tensSI<?php echo $i; ?> = 0;
                                                $("#secondsSI<?php echo $i; ?>").html("0" + secondsSI<?php echo $i; ?>);
                                            }
                                            if (secondsSI<?php echo $i; ?> > 9) {
                                                $("#secondsSI<?php echo $i; ?>").html(secondsSI<?php echo $i; ?>);
                                            }
                                        }
                                    </script>
                                                ...
                                                $.ajax({ //create an ajax request to display.php
                                                    ...
                                                    success: function(response) {
                                                        ...
                                                        if (stationInspection<?php echo $i; ?> != station.number) {
                                                            ...
                                                            // Start stopwatch 
                                                            clearInterval(IntervalSI<?php echo $i; ?>);
                                                            durationI<?php echo $i; ?> = secondsSI<?php echo $i; ?> + (tensSI<?php echo $i; ?> / 100);
                                                            tensSI<?php echo $i; ?> = "00";
                                                            secondsSI<?php echo $i; ?> = "00";
                                                            $("#secondsSI<?php echo $i; ?>").html(secondsSI<?php echo $i; ?>);
                                                            $("#tensSI<?php echo $i; ?>").html(tensSI<?php echo $i; ?>);
                                                            if (lineStatus != "end") {
                                                                IntervalSI<?php echo $i; ?> = setInterval(startTimerSI<?php echo $i; ?>, 10);
                                                            }
                                                            if (lineStatus == "breaktime") {
                                                                clearInterval(IntervalSI<?php echo $i; ?>);
                                                            }
                                                            ...
                                                            if (station.number != 0) {
                                                                ...
                                                                if (startTimeI<?php echo $i; ?> != 0) {
                                                                    var tactTimeI<?php echo $i; ?> = (Date.parse(timeI<?php echo $i; ?>) - Date.parse(startTimeI<?php echo $i; ?>)) / 1000;
                                                                    saveTactTime1("station", "<?php echo $i; ?>", "inspection", tactTimeI<?php echo $i; ?>, palletNoI<?php echo $i; ?>, autoserialI<?php echo $i; ?>);
                                    ...
                                    <style>
                                        ...
                                        .cubeinspection<?php echo $i; ?>.show-front {
                                            transform: translateZ(-50px) rotateY(-180deg);
                                        }

                                        .cubeinspection<?php echo $i; ?>.show-right {
                                            transform: translateZ(-50px) rotateY(-90deg);
                                        }

                                        .cubeinspection<?php echo $i; ?>.show-back {
                                            transform: translateZ(-50px) rotateY(180deg);
                                        }

                                        .cubeinspection<?php echo $i; ?>.show-left {
                                            transform: translateZ(-50px) rotateY(90deg);
                                        }

                                        .cubeinspection<?php echo $i; ?>.show-top {
                                            transform: translateZ(-50px) rotateX(-90deg);
                                        }

                                        .cubeinspection<?php echo $i; ?>.show-bottom {
                                            transform: translateZ(-50px) rotateX(90deg);
                                        }
                                        ...
                                        .cubeinspection<?php echo $i; ?>__face--front {
                                            background: (0, 100%, 50%, 1);
                                            background-color: #64e000;
                                        }

                                        .cubeinspection<?php echo $i; ?>__face--right {
                                            background: (60, 100%, 50%, 1);
                                            background-color: #64e000;
                                        }

                                        .cubeinspection<?php echo $i; ?>__face--back {
                                            background: (120, 100%, 50%, 1);
                                            background-color: #64e000;
                                        }

                                        .cubeinspection<?php echo $i; ?>__face--left {
                                            background: (180, 100%, 50%, 1);
                                            background-color: #64e000;
                                        }

                                        .cubeinspection<?php echo $i; ?>__face--top {
                                            background: (240, 100%, 50%, 1);
                                            background-color: #64e000;
                                        }

                                        .cubeinspection<?php echo $i; ?>__face--bottom {
                                            background: (300, 100%, 50%, 1);
                                            background-color: #64e000;
                                        }
                                ...
                                <script>
                                    ...
                                    function startTimerL4() {
                                        tensL4++;
                                        if (tensL4 < 9) {
                                            $("#tensL4").html("0" + tensL4);
                                        }
                                        if (tensL2 > 9) {
                                            $("#tensL4").html(tensL4);
                                        }
                                        if (tensL4 > 99) {
                                            secondsL4++;
                                            $("#secondsL4").html("0" + secondsL4);
                                            tensL4 = 0;
                                            $("#secondsL4").html("0" + secondsL4);
                                        }
                                        if (secondsL4 > 9) {
                                            $("#secondsL4").html(secondsL4);
                                        }
                                    }
                                </script>
                                            ...
                                            $.ajax({ //create an ajax request to display.php
                                                ...
                                                success: function(response) {
                                                    ...
                                                    if (lifter04 != lifter4.number) {
                                                        ...
                                                        durationL4 = secondsL4 + (tensL4 / 100);
                                                        tensL4 = "00";
                                                        secondsL4 = "00";
                                                        $("#secondsL4").html(secondsL4);
                                                        $("#tensL4").html(tensL4);
                                                        if (lineStatus != "end") {
                                                            IntervalL4 = setInterval(startTimerL4, 10);
                                                        }
                                                        if (lineStatus == "breaktime") {
                                                            clearInterval(IntervalL4);
                                                        }
                                                        ...
                                                        if (lifter4.number != 0) {
                                                            ...
                                                            if (startTimeL4 != 0) {
                                                                var tactTimeL4 = (Date.parse(timeL4) - Date.parse(startTimeL4)) / 1000;
                                                                console.log("Lifter 4 tact time:" + tactTimeL4);
                                                                saveTactTime1("lifter", "4", "inspection", tactTimeL4, palletNoL4, autoserialL4);
                                ...
                                <style>
                                    ...
                                    .cubelifter4.show-front {
                                        transform: translateZ(-50px) rotateY(-180deg);
                                    }

                                    .cubelifter4.show-right {
                                        transform: translateZ(-50px) rotateY(-90deg);
                                    }

                                    .cubelifter4.show-back {
                                        transform: translateZ(-50px) rotateY(180deg);
                                    }

                                    .cubelifter4.show-left {
                                        transform: translateZ(-50px) rotateY(90deg);
                                    }

                                    .cubelifter4.show-top {
                                        transform: translateZ(-50px) rotateX(-90deg);
                                    }

                                    .cubelifter4.show-bottom {
                                        transform: translateZ(-50px) rotateX(90deg);
                                    }
                                    ...
                                    .cubelifter4__face--front {
                                        background: (0, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter4__face--right {
                                        background: (60, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter4__face--back {
                                        background: (120, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter4__face--left {
                                        background: (180, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter4__face--top {
                                        background: (240, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }

                                    .cubelifter4__face--bottom {
                                        background: (300, 100%, 50%, 1);
                                        background-color: #f8f7eb;
                                    }
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5" align="center" style="color:#007bff; font-size: 15px;font-weight:bold;">
                                            <!-- <div id ="tactTimeLifter1" class="col-4" style="color:#007bff; font-size: 15px;font-weight:bold;"></div> -->
                                            <span id="secondsL1" style="color:#007bff; font-size: 15px;font-weight:bold;">00</span>:<span id="tensL1" style="color:#007bff; font-size: 15px;font-weight:bold;">00</span>
                                        </div>
                                    </div>

                                    <!-- Tact time value monitor  -->
                                    <?php for ($i = 1; $i <= 10; $i++) : ?>
                                        <div class="row">
                                            <div class="col-7">
                                                <h1 style="color:#ffc107; font-size: 15px;font-weight:bold;">Station <?php echo $i; ?> </h1>
                                            </div>
                                            <div class="col-5" align="center" style="color:#ffc107; font-size: 15px;font-weight:bold;">
                                                <span id="secondsSA<?php echo $i; ?>" style="color:#ffc107; font-size: 15px;font-weight:bold;">00</span>:<span id="tensSA<?php echo $i; ?>" style="color:#ffc107; font-size: 15px;font-weight:bold;">00</span>
                                            </div>
                                        </div>
                                    <?php endfor; ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5" align="center" style="color:#007bff; font-size: 15px;font-weight:bold;">
                                            <span id="secondsL2" style="color:#007bff; font-size: 15px;font-weight:bold;">00</span>:<span id="tensL2" style="color:#007bff; font-size: 15px;font-weight:bold;">00</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5" align="center" style="color:#f8f7eb; font-size: 15px;font-weight:bold;">
                                            <!-- <div id ="tactTimeLifter3" class="col-4" style="color:#f8f7eb; font-size: 15px;font-weight:bold;"></div> -->
                                            <span id="secondsL3" style="color:#f8f7eb; font-size: 15px;font-weight:bold;">00</span>:<span id="tensL3" style="color:#f8f7eb; font-size: 15px;font-weight:bold;">00</span>
                                        </div>
                                    </div>
                                    ...
                                    <?php for ($i = 1; $i <= 11; $i++) : ?>
                                        <div class="row">
                                            ...
                                            <div class="col-5" align="center" style="color:#64e000; font-size: 15px;font-weight:bold;">
                                                <span id="secondsSI<?php echo $i; ?>" style="color:#64e000; font-size: 15px;font-weight:bold;">00</span>:<span id="tensSI<?php echo $i; ?>" style="color:#64e000; font-size: 15px;font-weight:bold;">00</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5" align="center" style="color:#f8f7eb; font-size: 15px;font-weight:bold;">
                                            ...
                                            <span id="secondsL4" style="color:#f8f7eb; font-size: 15px;font-weight:bold;">00</span>:<span id="tensL4" style="color:#f8f7eb; font-size: 15px;font-weight:bold;">00</span>
                                        </div>
                                    </div>
                                </div>
