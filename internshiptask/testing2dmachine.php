<html>
    <head>
        ...
        *::after {
        ...
        transform: translateX(850px) translateY(200px);/*transform: translateY(370px) rotateX(60deg) rotateZ(20deg); /*move to 2d from top to bottom*/
        ...
        height: 100%;
        border-radius: 50%;
        background-color: #fe0000; /*#40F526*/
        ...
        .cylinder > .cylinder-sideto .cylinder-sideto {
        position: absolute;
        left: 100%;
        width: 100%;
        height: 100%;
        ...
        .cylinder .cylinder-sideto.color2 {
        ...
        height: 200px;
        transform-origin: 50% 100%;
        transform: translateX(-50%) translateY(-220px) rotateY(0deg); /*original (transform: translateX(-50%) translateY(-100%) rotateX(-90deg) translateY(-220px) rotateY(0deg);)*/
        transform-style: preserve-3d;
        }
        </style>
    </head>
...
<div class="floor">
  <div class="shape shape1">
    <div class="shape metrics-popup">
      <div class="sideto right"></div>
      <div class="sideto left"></div>
      <div class="sideto front"></div>
      <div class="sideto back">
        <div class="sideto metric-panel-screen">
          <div class="mTitle">L09 Station 1</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
            <span id="L09part7condition" class="metric-name"></span>
          </div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
    ...
    <div class="sideto right">
      <div class="sideto inner-base"></div>
      <div class="sideto openning open-sideto">
        ...
        <div class="sideto corner">
          Corner
          <div class="sideto top">
            <div class="chakalaka">
              <div class="chakalaka-content">
                <div id="L09part7" class="chakalaka-top" style="background:black;">
                  
                </div>
                <div class="chakalaka-cylinder" >
                  <div class="cylinder">
                    <div class="cylinder-sideto color2">
                      <div class="cylinder-sideto">
                        <div class="cylinder-sideto color2">
                          <div class="cylinder-sideto">
                            <div class="cylinder-sideto color2">
                              <div class="cylinder-sideto">
    ...
    <div class="sideto left">
    </div>
    <div class="sideto front">
      Front
      <div class="sideto fornt-corner">
        corner
      </div>
    </div>
    <div class="sideto back">
      ...
      <div class="shape alarm-panel active-screen">
        ...
        <div class="sideto front"></div>
        <div class="sideto back">
          <div class="sideto alarm-panel-screen" ></div>
        </div>
      </div>
      <div class="sideto back-corner" >
        corner
      </div>
    </div>
  </div>
  ...
  <div class="shape shape3">
    <div class="shape metrics-popup">
      ...
      <div class="sideto back">
        <div class="sideto metric-panel-screen">
          <div class="mTitle">L09 Station 3</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape2">
    <div class="shape metrics-popup">
      ...
      <div class="sideto back">
        <div class="sideto metric-panel-screen">
          <div class="mTitle">L09 Station 2</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
    ...
    <div class="chip c1" style="background-image:url(media/circuitboarddemo01.jpg);"></div>
    <div class="chip c2" style="background-image:url(media/circuitboarddemo01.jpg);"></div>
    <div class="sideto right">
      <div class="sideto inner-base"></div>
      <div class="sideto openning open-sideto">
        <div class="openning-left"></div>
  ...
  <div class="shape shape4">
    <div class="shape metrics-popup">
      ...
      <div class="sideto back">
        <div class="sideto metric-panel-screen">
          <div class="mTitle">L09 Station 5</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
    ...
    <div class="chip c1" style="background-image:url(https://drive.google.com/uc?id=1XflsByjAENEHX-Mf_ZkefL7oeXkJGIZC);"></div>
    <div class="chip c2" style="background-image:url(https://drive.google.com/uc?id=1XflsByjAENEHX-Mf_ZkefL7oeXkJGIZC);"></div>
    <div class="sideto right">
      <div class="sideto inner-base"></div>
      <div class="sideto openning open-sideto">
        <div class="openning-left"></div>
  ...
  <div class="shape shape5">
    <div class="shape metrics-popup">
      ...
      <div class="sideto back">
        <div class="sideto metric-panel-screen">
          <div class="mTitle">L09 Station 6</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
            ...
            success: function (response) {
                ...
                for (i = 7; i < response.length; i++) {
                    if(response[i].status=="Offline"){
                            ...
                            document.getElementById('L09part'+i).style.background = 'Grey';
                            document.getElementById('L09part'+i+'condition').textContent="Condition: Off";
                        }

                        else if(response[i].status=="Stop"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" yellow";
                            document.getElementById('L09part'+i).style.background = '#F53C42';
                            document.getElementById('L09part'+i+'condition').textContent="Condition: Stop";
                        }

                        else if(response[i].status=="Run"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" green";
                            document.getElementById('L09part'+i).style.background = '#00D45F'; //#8AFF4C light green //#00D45F normal green //#00B14F dark green
                            document.getElementById('L09part'+i+'condition').textContent="Condition: Run";
                        }

                        else if(response[i].status=="Break"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" blue";
                            document.getElementById('L09part'+i).style.background = '#FFEE4A'; 
                            document.getElementById('L09part'+i+'condition').textContent="Condition: Break";
                        }
