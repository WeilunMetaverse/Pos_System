...
<div class="floor">
    ...
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L08 Station 1</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
          <span id="L08part6condition" class="metric-name"></span>
          </div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
        ...
        <div class="side corner">
          ...
          <div class="side top">
            <div class="chakalaka">
              ...
              <div id="L08part6a" class="chakalaka-top" style="background:black; animation:blue 1s infinite;">
                    ...
                    <div class="cylinder-side color2">
                      <div class="cylinder-side" style="background:black; animation:blue 1s infinite;">
                        <div class="cylinder-side color2" style="background:black; animation:blue 1s infinite;">
                          <div class="cylinder-side" style="background:black; animation:blue 1s infinite;">
                            <div id="L08part6b" class="cylinder-side color2" style="background:black; animation:blue 1s infinite;">
                              <div id="L08part6c" class="cylinder-side" style="background:black; animation:blue 1s infinite;">
                                <div id="L08part6d" class="cylinder-side color2" style="background:black; animation:blue 1s infinite;">
                                  <div id="L08part6e" class="cylinder-side" style="background:black; animation:blue 1s infinite;">
  ...
  <div class="shape shape3">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L08 Station 3</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape2">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L08 Station 2</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape4">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L08 Station 5</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape5">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L08 Station 6</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
            ...
            success: function (response) {
                ...
                for (i = 6; i < response.length; i++) {
                    if(response[i].status=="Offline"){
                            ...
                            document.getElementById('L08part'+i+'a').style.animation = 'grey 1s infinite';
                            document.getElementById('L08part'+i+'b').style.animation = 'grey 1s infinite';
                            document.getElementById('L08part'+i+'c').style.animation = 'grey 1s infinite';
                            document.getElementById('L08part'+i+'d').style.animation = 'grey 1s infinite';
                            document.getElementById('L08part'+i+'e').style.animation = 'grey 1s infinite';
                        }
                            ...
                            document.getElementById('L08part'+i+'a').style.animation = 'red 1s infinite';
                            document.getElementById('L08part'+i+'b').style.animation = 'red 1s infinite';
                            document.getElementById('L08part'+i+'c').style.animation = 'red 1s infinite';
                            document.getElementById('L08part'+i+'d').style.animation = 'red 1s infinite';
                            document.getElementById('L08part'+i+'e').style.animation = 'red 1s infinite';
                        }
                            ...
                            document.getElementById('L08part'+i+'a').style.animation = 'green 1s infinite';
                            document.getElementById('L08part'+i+'b').style.animation = 'green 1s infinite';
                            document.getElementById('L08part'+i+'c').style.animation = 'green 1s infinite';
                            document.getElementById('L08part'+i+'d').style.animation = 'green 1s infinite';
                            document.getElementById('L08part'+i+'e').style.animation = 'green 1s infinite';
                        }
                            ...
                            document.getElementById('L08part'+i+'a').style.animation = 'yellow 1s infinite';
                            document.getElementById('L08part'+i+'b').style.animation = 'yellow 1s infinite';
                            document.getElementById('L08part'+i+'c').style.animation = 'yellow 1s infinite';
                            document.getElementById('L08part'+i+'d').style.animation = 'yellow 1s infinite';
                            document.getElementById('L08part'+i+'e').style.animation = 'yellow 1s infinite';
                        }
