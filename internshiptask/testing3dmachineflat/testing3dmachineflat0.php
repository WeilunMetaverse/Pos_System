...
<div class="floor">
    ...
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        ...
        <div class="flip-card">
            ...
            <span id="outputvalue0"></span>
            <br>
            <span id="outputvalue0t"></span>
            <br><span id="L01part0condition" class="metric-name"></span></b></div>
        
          <div class="mTitle"></div>
          </div>
          <!--<div class="mTitle">L01 Station 1</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
          <span id="L01part0condition" class="metric-name"></span>
          </div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>-->
        ...
        <div class="side corner">
          ...
          <div class="side top">
            <div class="chakalaka">
              ...
              <div id="L01part0a" class="chakalaka-top" style="background:black; animation:blue 1s infinite;">
                  
                  </div>
                <div class="chakalaka-cylinder">
                  <div class="cylinder">
                    <div class="cylinder-side color2">
                      <div class="cylinder-side" style="background:black; animation:blue 1s infinite;">
                        <div class="cylinder-side color2" style="background:black; animation:blue 1s infinite;">
                          <div class="cylinder-side" style="background:black; animation:blue 1s infinite;">
                            <div id="L01part0b" class="cylinder-side color2" style="background:black; animation:blue 1s infinite;">
                              <div id="L01part0c" class="cylinder-side" style="background:black; animation:blue 1s infinite;">
                                <div id="L01part0d" class="cylinder-side color2" style="background:black; animation:blue 1s infinite;">
                                  <div id="L01part0e" class="cylinder-side" style="background:black; animation:blue 1s infinite;">
  ...
  <div class="shape shape3">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L01 Station 3</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape2">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L01 Station 2</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape4">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L01 Station 5</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape5">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L01 Station 6</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
            ...
            success: function (response) {
                ...
                for (i = 0; i < response.length; i++) {
                    ...
                    if(response[i].status=="Offline"){
                            ...
                            document.getElementById('L01part'+i+'a').style.animation = 'grey 1s infinite';
                            document.getElementById('L01part'+i+'b').style.animation = 'grey 1s infinite';
                            document.getElementById('L01part'+i+'c').style.animation = 'grey 1s infinite';
                            document.getElementById('L01part'+i+'d').style.animation = 'grey 1s infinite';
                            document.getElementById('L01part'+i+'e').style.animation = 'grey 1s infinite';
                        }

                        else if(response[i].status=="Stop"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" yellow";
                            document.getElementById('L01part'+i+'a').style.background = '#F53C42';
                            document.getElementById('L01part'+i+'b').style.background = '#F53C42';
                            document.getElementById('L01part'+i+'c').style.background = '#F53C42';
                            document.getElementById('L01part'+i+'d').style.background = '#F53C42';
                            document.getElementById('L01part'+i+'e').style.background = '#F53C42';

                            document.getElementById('L01part'+i+'condition').textContent="Condition: Stop";
                            ...
                            document.getElementById('L01part'+i+'a').style.animation = 'green 1s infinite';
                            document.getElementById('L01part'+i+'b').style.animation = 'green 1s infinite';
                            document.getElementById('L01part'+i+'c').style.animation = 'green 1s infinite';
                            document.getElementById('L01part'+i+'d').style.animation = 'green 1s infinite';
                            document.getElementById('L01part'+i+'e').style.animation = 'green 1s infinite';
                        }
                            ...
                            document.getElementById('L01part'+i+'a').style.animation = 'yellow 1s infinite';
                            document.getElementById('L01part'+i+'b').style.animation = 'yellow 1s infinite';
                            document.getElementById('L01part'+i+'c').style.animation = 'yellow 1s infinite';
                            document.getElementById('L01part'+i+'d').style.animation = 'yellow 1s infinite';
                            document.getElementById('L01part'+i+'e').style.animation = 'yellow 1s infinite';
                        }
