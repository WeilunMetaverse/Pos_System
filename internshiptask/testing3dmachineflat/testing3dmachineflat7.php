        ...
        <div class="side corner">
          ...
          <div class="side top">
            <div class="chakalaka">
              ...
              <div id="L09part7a" class="chakalaka-top" style="background:black;">
                  ...
                  <div class="cylinder">
                    <div class="cylinder-side color2">
                      <div class="cylinder-side">
                        <div class="cylinder-side color2">
                          <div class="cylinder-side">
                            <div id="L09part7b" class="cylinder-side color2" style="background:black;">
                              <div id="L09part7c" class="cylinder-side" style="background:black;">
                                <div id="L09part7d" class="cylinder-side color2" style="background:black;">
                                  <div id="L09part7e" class="cylinder-side"style="background:black;">
            ...
            success: function (response) {
                ...
                for (i = 7; i < response.length; i++) {
                    if(response[i].status=="Offline"){
                            ...
                            document.getElementById('L09part'+i+'a').style.background = 'Grey';
                            document.getElementById('L09part'+i+'b').style.background = 'Grey';
                            document.getElementById('L09part'+i+'c').style.background = 'Grey';
                            document.getElementById('L09part'+i+'d').style.background = 'Grey';
                            document.getElementById('L09part'+i+'e').style.background = 'Grey';
                            ...
                            document.getElementById('L09part'+i+'a').style.background = '#F53C42';
                            document.getElementById('L09part'+i+'b').style.background = '#F53C42';
                            document.getElementById('L09part'+i+'c').style.background = '#F53C42';
                            document.getElementById('L09part'+i+'d').style.background = '#F53C42';
                            document.getElementById('L09part'+i+'e').style.background = '#F53C42';
                            ...
                            document.getElementById('L09part'+i+'a').style.background = '#00D45F'; //#8AFF4C light green //#00D45F normal green //#00B14F dark green
                            document.getElementById('L09part'+i+'b').style.background = '#00D45F';
                            document.getElementById('L09part'+i+'c').style.background = '#00D45F';
                            document.getElementById('L09part'+i+'d').style.background = '#00D45F';
                            document.getElementById('L09part'+i+'e').style.background = '#00D45F';
                            ...
                            document.getElementById('L09part'+i+'a').style.background = '#FFEE4A'; 
                            document.getElementById('L09part'+i+'b').style.background = '#FFEE4A';
                            document.getElementById('L09part'+i+'c').style.background = '#FFEE4A';
                            document.getElementById('L09part'+i+'d').style.background = '#FFEE4A';
                            document.getElementById('L09part'+i+'e').style.background = '#FFEE4A';
