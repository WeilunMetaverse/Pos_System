...
<div class="floor">
    ...
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L22 Station 1</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
          <span id="L22part14condition" class="metric-name"></span>
          </div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
        ...
        <div class="side corner">
          ...
          <div class="side top">
            <div class="chakalaka">
              ...
              <div id="L22part14a" class="chakalaka-top" style="background:black;">
                  ...
                  <div class="cylinder">
                    <div class="cylinder-side color2">
                      <div class="cylinder-side">
                        <div class="cylinder-side color2">
                          <div class="cylinder-side">
                            <div id="L22part14b" class="cylinder-side color2" style="background:black;">
                              <div id="L22part14c" class="cylinder-side" style="background:black;">
                                <div id="L22part14d" class="cylinder-side color2" style="background:black;">
                                  <div id="L22part14e" class="cylinder-side"style="background:black;">
  ...
  <div class="shape shape3">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L22 Station 3</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape2">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L22 Station 2</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape4">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L22 Station 5</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape5">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L22 Station 6</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
    ...
    function getDataCounter() {
        $.ajax({    //create an ajax request to display.php
            ...
            success: function (response) {
                ...
                for (i = 14; i < response.length; i++) {
                    if(response[i].status=="Offline"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" red";
                            document.getElementById('L22part'+i+'a').style.background = 'Grey';
                            document.getElementById('L22part'+i+'b').style.background = 'Grey';
                            document.getElementById('L22part'+i+'c').style.background = 'Grey';
                            document.getElementById('L22part'+i+'d').style.background = 'Grey';
                            document.getElementById('L22part'+i+'e').style.background = 'Grey';
                            document.getElementById('L22part'+i+'condition').textContent="Condition: Off";
                        }

                        else if(response[i].status=="Stop"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" yellow";
                            document.getElementById('L22part'+i+'a').style.background = '#F53C42';
                            document.getElementById('L22part'+i+'b').style.background = '#F53C42';
                            document.getElementById('L22part'+i+'c').style.background = '#F53C42';
                            document.getElementById('L22part'+i+'d').style.background = '#F53C42';
                            document.getElementById('L22part'+i+'e').style.background = '#F53C42';
                            document.getElementById('L22part'+i+'condition').textContent="Condition: Stop";
                        }

                        else if(response[i].status=="Run"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" green";
                            document.getElementById('L22part'+i+'a').style.background = '#00D45F'; //#8AFF4C light green //#00D45F normal green //#00B14F dark green
                            document.getElementById('L22part'+i+'b').style.background = '#00D45F';
                            document.getElementById('L22part'+i+'c').style.background = '#00D45F';
                            document.getElementById('L22part'+i+'d').style.background = '#00D45F';
                            document.getElementById('L22part'+i+'e').style.background = '#00D45F';
                            document.getElementById('L22part'+i+'condition').textContent="Condition: Run";
                        }

                        else if(response[i].status=="Break"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" blue";
                            document.getElementById('L22part'+i+'a').style.background = '#FFEE4A'; 
                            document.getElementById('L22part'+i+'b').style.background = '#FFEE4A';
                            document.getElementById('L22part'+i+'c').style.background = '#FFEE4A';
                            document.getElementById('L22part'+i+'d').style.background = '#FFEE4A';
                            document.getElementById('L22part'+i+'e').style.background = '#FFEE4A';
                            document.getElementById('L22part'+i+'condition').textContent="Condition: Break";
                        }
