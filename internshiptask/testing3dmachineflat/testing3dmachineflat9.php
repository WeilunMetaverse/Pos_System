...
<div class="floor">
    ...
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L12 Station 1</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
          <span id="L12part9condition" class="metric-name"></span>
          </div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
        ...
        <div class="side corner">
          ...
          <div class="side top">
            <div class="chakalaka">
              ...
              <div id="L12part9a" class="chakalaka-top" style="background:black;">
                  ...
                  <div class="cylinder">
                    <div class="cylinder-side color2">
                      <div class="cylinder-side">
                        <div class="cylinder-side color2">
                          <div class="cylinder-side">
                            <div id="L12part9b" class="cylinder-side color2" style="background:black;">
                              <div id="L12part9c" class="cylinder-side" style="background:black;">
                                <div id="L12part9d" class="cylinder-side color2" style="background:black;">
                                  <div id="L12part9e" class="cylinder-side"style="background:black;">
  ...
  <div class="shape shape3">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L12 Station 3</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape2">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L12 Station 2</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape4">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L12 Station 5</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
  ...
  <div class="shape shape5">
    <div class="shape metrics-popup">
      ...
      <div class="side back">
        <div class="side metric-panel-screen">
          <div class="mTitle">L12 Station 6</div>
          <div class="metric">
            <span class="metric-name"></span>
          </div>
          <div class="metric">
            ...
            success: function (response) {
                ...
                for (i = 9; i < response.length; i++) {
                    if(response[i].status=="Offline"){
                            ...
                            document.getElementById('L12part'+i+'a').style.background = 'Grey';
                            document.getElementById('L12part'+i+'b').style.background = 'Grey';
                            document.getElementById('L12part'+i+'c').style.background = 'Grey';
                            document.getElementById('L12part'+i+'d').style.background = 'Grey';
                            document.getElementById('L12part'+i+'e').style.background = 'Grey';
                            document.getElementById('L12part'+i+'condition').textContent="Condition: Off";

                            document.getElementById('L12part'+i+'a').style.animation = 'grey 1s infinite';
                            document.getElementById('L12part'+i+'b').style.animation = 'grey 1s infinite';
                            document.getElementById('L12part'+i+'c').style.animation = 'grey 1s infinite';
                            document.getElementById('L12part'+i+'d').style.animation = 'grey 1s infinite';
                            document.getElementById('L12part'+i+'e').style.animation = 'grey 1s infinite';
                        }

                        else if(response[i].status=="Stop"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" yellow";
                            document.getElementById('L12part'+i+'a').style.background = '#F53C42';
                            document.getElementById('L12part'+i+'b').style.background = '#F53C42';
                            document.getElementById('L12part'+i+'c').style.background = '#F53C42';
                            document.getElementById('L12part'+i+'d').style.background = '#F53C42';
                            document.getElementById('L12part'+i+'e').style.background = '#F53C42';
                            document.getElementById('L12part'+i+'condition').textContent="Condition: Stop";

                            document.getElementById('L12part'+i+'a').style.animation = 'red 1s infinite';
                            document.getElementById('L12part'+i+'b').style.animation = 'red 1s infinite';
                            document.getElementById('L12part'+i+'c').style.animation = 'red 1s infinite';
                            document.getElementById('L12part'+i+'d').style.animation = 'red 1s infinite';
                            document.getElementById('L12part'+i+'e').style.animation = 'red 1s infinite';
                        }

                        else if(response[i].status=="Run"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" green";
                            document.getElementById('L12part'+i+'a').style.background = '#00D45F'; //#8AFF4C light green //#00D45F normal green //#00B14F dark green
                            document.getElementById('L12part'+i+'b').style.background = '#00D45F';
                            document.getElementById('L12part'+i+'c').style.background = '#00D45F';
                            document.getElementById('L12part'+i+'d').style.background = '#00D45F';
                            document.getElementById('L12part'+i+'e').style.background = '#00D45F';
                            document.getElementById('L12part'+i+'condition').textContent="Condition: Run";

                            document.getElementById('L12part'+i+'a').style.animation = 'green 1s infinite';
                            document.getElementById('L12part'+i+'b').style.animation = 'green 1s infinite';
                            document.getElementById('L12part'+i+'c').style.animation = 'green 1s infinite';
                            document.getElementById('L12part'+i+'d').style.animation = 'green 1s infinite';
                            document.getElementById('L12part'+i+'e').style.animation = 'green 1s infinite';
                        }

                        else if(response[i].status=="Break"){
                            //document.getElementById('dep'+i).className = "circle position"+i+" blue";
                            document.getElementById('L12part'+i+'a').style.background = '#FFEE4A'; 
                            document.getElementById('L12part'+i+'b').style.background = '#FFEE4A';
                            document.getElementById('L12part'+i+'c').style.background = '#FFEE4A';
                            document.getElementById('L12part'+i+'d').style.background = '#FFEE4A';
                            document.getElementById('L12part'+i+'e').style.background = '#FFEE4A';
                            document.getElementById('L12part'+i+'condition').textContent="Condition: Break";

                            document.getElementById('L12part'+i+'a').style.animation = 'yellow 1s infinite';
                            document.getElementById('L12part'+i+'b').style.animation = 'yellow 1s infinite';
                            document.getElementById('L12part'+i+'c').style.animation = 'yellow 1s infinite';
                            document.getElementById('L12part'+i+'d').style.animation = 'yellow 1s infinite';
                            document.getElementById('L12part'+i+'e').style.animation = 'yellow 1s infinite';
                        }
