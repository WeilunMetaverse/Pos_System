<?php
include 'data/connection_productionline.php';

$sql = "SELECT * FROM productionline;";
$result = mysqli_query($conn, $sql);
#$resultCheck = mysqli_num_rows($result);
$row = mysqli_fetch_row($result);
#$data=mysqli_fetch_array($resultCheck,MYSQLI_BOTH)
#if($data > 0 ){
    #while($data["Station_Name"] == ){
        #echo $row;
    #}
#}
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------->        
        ...
        /////-------------------------------------------------------------------------------------------------------------------------------------------------------------------//
                            $("#flexdisplay").empty();
                                ...
                                $("#flexdisplay").append('<div class="container2">'+
                                '<p class="smallcontainer"></p>'+
                                '<img id="robot'+i+'" class="img" src="media/robot2150.gif" alt="" style="left:'+i*200+'px; display:block;">'+
                                '<img id="human'+i+'" class="imgh" src="media/human2.png" alt="" style="left:'+i*200+'px; display:none;justify-content:center;">'+
                                '<ul class="flex-container">'+
                                '<p id="output'+i+'t" class="displayoutput2" style="left:'+i*200+'px;"></p>'+
                                '<li id="flex'+i+'t" class="flex-item2" style="left:'+i*200+'px;"></li>'+
                                '</ul>'+
                                '<ul class="flex-container">'+
                                '<p id="output'+i+'" class="displayoutput" style="left:'+i*200+'px;"></p>'+
                                '<li'+i+' id="flex'+i+'" class="flex-item" style="left:'+i*200+'px;">'+i+'</li'+i+'>'+
                                '</ul>'+
                                '<notificationpop id="displaypop'+i+'" style="left:'+i*200+'px;top:-250px;display:block;font-weight:bold;">!</notificationpop>'+
                                '</div>'
