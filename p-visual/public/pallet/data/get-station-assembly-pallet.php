...
$url = 'assemblyStation.json'; // path to your JSON file
...
$palletNumber = sprintf("SELECT VALUE,TIMESTAMP from $palletTable where ADDRESS=$number ORDER BY TIMESTAMP DESC LIMIT 1");
...
if( $palletNumber >= 16 && $palletNumber != 153){
  $palletNumber = $palletNumber-6;
}
...
// $palletNumber = hexdec($palletNumber);
//
...
// $palletAutoserial = sprintf("SELECT VALUE from $palletTable where ADDRESS=$autoSerial ORDER BY TIMESTAMP DESC LIMIT 1");
...
$palletData = (object) [
  ...
  'timeStamp'=> $numberResult->TIMESTAMP,
  'autoserial'=> "No data",
];
